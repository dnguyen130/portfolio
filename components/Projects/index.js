	...
	return (
		<ProjectsWrapper>
			<ProjectsCont>
				...
				>
					<ProjectDescriptionCont>
						<ProjectHeader headercolor={site_theme[theme].onme}>
							OnMe
						</ProjectHeader>
						<ProjectDescription desccolor={site_theme[theme].text}>
							...
							<ProjectList>
								<ProjectListItem>
									Cross-platform mobile application designed to combat
								...
								<ProjectListItem>
									Designed and developed in 12 weeks by student designers and
									developers.
								</ProjectListItem>
								<ProjectListItem>
									Proof of concept presented to over 100 people, including
			...
			<ProjectsCont2>
				...
				>
					<ProjectDescriptionCont>
						<ProjectHeader2 headercolor={site_theme[theme].steady}>
							Steady
						</ProjectHeader2>
						<ProjectDescription desccolor={site_theme[theme].text}>
							...
							<ProjectList>
								...
								<ProjectListItem>
									Answer questions based on eating, sleeping, and exercise
									habits.
								</ProjectListItem>
								<ProjectListItem>
								...
								<ProjectListItem>
									Researched, designed, prototyped, tested, and developed by
									first year D3 students.
								</ProjectListItem>
							</ProjectList>
							<ButtonCont2>
								<Button
