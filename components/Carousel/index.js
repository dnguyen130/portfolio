...
const Carousel = () => {
	...
	return (
		...
		>
			<Slider
				className="Carousel2"
				style={{ borderColor: site_theme[theme].text }}
			>
				<Slide index={0}>
					<Image
						src={welcome}
						alt="Steady Welcome Page"
						width="285px"
						height="440px"
					/>
				</Slide>
